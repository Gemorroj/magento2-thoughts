...
### по конторе
- Работают чисто на саппорт.
- возможно, нет глубоких компетеций (пока мало сотрудников знаю).
- исповедуют подход "работает - не трогай".
- мир в себе, игнорируется менстрим, велосипедостроение.
- веротяно, нет желания технологического роста.
